<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
    ...
    <!-- chartist chart -->
    <script src="<?=base_url()?>/assets/admin/plugins/bower_components/chartist-js/dist/chartist.min.js"></script>
    <script src="<?=base_url()?>/assets/admin/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
